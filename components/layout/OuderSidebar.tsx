...
export function OuderSidebar() {
    ...
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-2 px-4 py-5 border-b border-green-900">
        ...
        <div>
          ...
          <p className="text-green-300 text-xs">Ouder / Voogd</p>
        </div>
      </div>
  ...
  return (
    <>
      <Button variant="ghost" size="icon" className="fixed top-3 left-3 z-50 md:hidden bg-green-800 text-white hover:bg-green-700" onClick={() => setMobileOpen(!mobileOpen)}>
