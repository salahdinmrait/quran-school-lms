...
const navItemDefs = [
  { href: "/admin", key: "nav_dashboard" as const, icon: LayoutDashboard, exact: true },
  { href: "/admin/gebruikers", key: "nav_gebruikers" as const, icon: Users },
    ...
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-2 px-4 py-5 border-b border-green-900">
        ...
        <div>
          ...
          <p className="text-green-300 text-xs">Beheerder</p>
        </div>
      </div>
