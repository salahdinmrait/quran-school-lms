...
import {
  LayoutDashboard, Calendar, Star, UserCheck,
  BookOpen, MessageSquare, LogOut, GraduationCap, Menu, X,
} from "lucide-react";
...
const navItemDefs = [
  ...
  { href: "/leerling/berichten", key: "nav_berichten" as const, icon: MessageSquare },
];

export function LeerlingaSidebar() {
    ...
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-2 px-4 py-5 border-b border-green-900">
        ...
        <div>
          ...
          <p className="text-green-300 text-xs">Leerling</p>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <aside className={cn("fixed top-0 left-0 z-40 h-full w-60 bg-green-800 transition-transform md:hidden", mobileOpen ? "translate-x-0" : "-translate-x-full")}>
        <SidebarContent />
      </aside>
